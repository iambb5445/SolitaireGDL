...
from player import Player, RandomPlayer, RandomNoRepeatPlayer, MCTSPlayer, spider_heuristic, action_count_heuristic
...
if __name__ == '__main__':
    ...
    # simulate_for_player(10, 1000, game, lambda: RandomNoRepeatPlayer(None, action_count_heuristic))
    simulate_for_player(1, 1000, game, lambda: MCTSPlayer(100, None, 100, lambda: RandomNoRepeatPlayer(None, action_count_heuristic)))